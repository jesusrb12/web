...
export class LoginService {
  ...
  public servicioUrl = 'http://jrbsecuritypayment.azurewebsites.net/api/Token/'; // URL to web API
  ...
  public getToken(usuario: Usuario): Observable<any> {
    return this.http.post<any>(this.servicioUrl,
      JSON.stringify(usuario), httpOptions).pipe(map((res: HttpResponse<any>) => {
        ...
        // console.log("DATA =" + res.body["access_Token"]);
        // if (res.body["access_Token"]) {
        //   console.log("DATA =" + res.body["access_Token"]); 
        //   usuario.token = res.body["access_Token"];
        // }
        return usuario;
